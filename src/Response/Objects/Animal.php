...
class Animal
{
     ...
     * @var string
     */
    public $animalActivityLevel;

    /**
     * Adopted Date
     * @var \DateTime
     */
    public $animalAdoptedDate;

    /**
     * Adoption fee
     * @var string
     */
    public $animalAdoptionFee;
     ...
     * @var string
     */
    public $animalAltered;

    /**
     * Application
     * @var integer
     */
    public $animalApplicationID;

    /**
     * Available Date
     * @var \DateTime
     */
    public $animalAvailableDate;

    /**
     * Birthdate
     * @var \DateTime
     */
    public $animalBirthdate;

    /**
     * Exact Birthdate
     * @var string
     */
    public $animalBirthdateExact;

    /**
     * Coat Length
     * @var string
     */
    public $animalCoatLength;

    /**
     * Colony
     * @var integer
     */
    public $animalColonyID;

    /**
     * Color (General)
     * @var integer
     */
    public $animalColorID;

    /**
     * Color details
     * @var string
     */
    public $animalColorDetails;
     ...
     * @var string
     */
    public $animalCourtesy;

    /**
     * Declawed
     * @var string
     */
    public $animalDeclawed;
     ...
     * @var string
     */
    public $animalDistinguishingMarks;

    /**
     * Allow export
     * @var string
     */
    public $animalAllowExport;

    /**
     * Ear type
     * @var string
     */
    public $animalEarType;

    /**
     * Energy level
     * @var string
     */
    public $animalEnergyLevel;

    /**
     * Exercise needs
     * @var string
     */
    public $animalExerciseNeeds;

    /**
     * Eye color
     * @var string
     */
    public $animalEyeColor;
     ...
     * @var \DateTime
     */
    public $animalFoundDate;

    /**
     * Found zip/postal code
     * @var string
     */
    public $animalFoundPostalcode;

    /**
     * General Age
     * @var string
     */
    public $animalGeneralAge;

    /**
     * Size potential (general)
     * @var string
     */
    public $animalGeneralSizePotential;

    /**
     * Grooming needs
     * @var string
     */
    public $animalGroomingNeeds;

    /**
     * Highlight
     * @var string
     */
    public $animalHighlightOrder;

    /**
     * Housetrained
     * @var string
     */
    public $animalHousetrained;

    /**
     * Indoor/Outdoor
     * @var string
     */
    public $animalIndoorOutdoor;

    /**
     * Internal ID
     * @var string
     */
    public $animalInternalID;

    /**
     * Euthanasia date
     * @var \DateTime
     */
    public $animalKillDate;

    /**
     * Euthanasia reason
     * @var string
     */
    public $animalKillReason;

    /**
     * Location
     * @var integer
     */
    public $animalLocationID;

    /**
     * Location public
     * @var string
     */
    public $animalLocationPublic;

    /**
     * Microchip number
     * @var string
     */
    public $animalMicrochipNumber;

    /**
     * Microchip vendor
     * @var integer
     */
    public $animalMicrochipVendor;

    /**
     * Mixed breed
     * @var string
     */
    public $animalMixedBreed;
     ...
     * @var string
     */
    public $animalNeedsFoster;

    /**
     * Reaction to new people
     * @var string
     */
    public $animalNewPeople;
     ...
     * @var string
     */
    public $animalNotHousetrainedReason;

    /**
     * Obedience training
     * @var string
     */
    public $animalObedienceTraining;

    /**
     * Good with adults
     * @var string
     */
    public $animalOKWithAdults;

    /**
     * OK with cats
     * @var string
     */
    public $animalOKWithCats;

    /**
     * OK with dogs
     * @var string
     */
    public $animalOKWithDogs;

    /**
     * OK with kids
     * @var string
     */
    public $animalOKWithKids;
     ...
     * @var string
     */
    public $animalOthernames;

    /**
     * Owner experience needed
     * @var string
     */
    public $animalOwnerExperience;

    /**
     * Owner
     * @var integer
     */
    public $animalOwnerID;
     ...
     * @var integer
     */
    public $animalPrimaryBreedID;

    /**
     * Received date
     * @var \DateTime
     */
    public $animalReceivedDate;

    /**
     * Rescue ID
     * @var string
     */
    public $animalRescueID;

    /**
     * Secondary Breed
     * @var integer
     */
    public $animalSecondaryBreedID;
     ...
     * @var string
     */
    public $animalShedding;

    /**
     * Current size
     * @var float
     */
    public $animalSizeCurrent;

    /**
     * Size potential
     * @var float
     */
    public $animalSizePotential;
     ...
     * @var integer
     */
    public $animalSpeciesID;

    /**
     * Allow sponsorship
     * @var string
     */
    public $animalSponsorable;

    /**
     * Sponsors
     * @var string
     */
    public $animalSponsors;

    /**
     * Sponsorship details
     * @var string
     */
    public $animalSponsorshipDetails;

    /**
     * Sponsorship minimum
     * @var float
     */
    public $animalSponsorshipMinimum;

    /**
     * Status
     * @var integer
     */
    public $animalStatusID;
     ...
     * @var string
     */
    public $animalTailType;

    /**
     * Transferred to
     * @var integer
     */
    public $animalTransferredToID;

    /**
     * Up-to-date
     * @var string
     */
    public $animalUptodate;
     ...
     * @var string
     */
    public $animalYardRequired;

    /**
     * Affectionate
     * @var string
     */
    public $animalAffectionate;

    /**
     * Apartment appropriate
     * @var string
     */
    public $animalApartment;

    /**
     * Crate trained
     * @var string
     */
    public $animalCratetrained;
     ...
     * @var string
     */
    public $animalEagerToPlease;

    /**
     * Tries to escape
     * @var string
     */
    public $animalEscapes;

    /**
     * Even-tempered
     * @var string
     */
    public $animalEventempered;

    /**
     * Likes to fetch
     * @var string
     */
    public $animalFetches;
     ...
     * @var string
     */
    public $animalHasAllergies;

    /**
     * Hearing impaired
     * @var string
     */
    public $animalHearingImpaired;

    /**
     * Hypoallergenic
     * @var string
     */
    public $animalHypoallergenic;

    /**
     * Independent / aloof
     * @var string
     */
    public $animalIndependent;

    /**
     * Intelligent
     * @var string
     */
    public $animalIntelligent;
     ...
     * @var string
     */
    public $animalLeashtrained;

    /**
     * Needs companion animal
     * @var string
     */
    public $animalNeedsCompanionAnimal;
     ...
     * @var string
     */
    public $animalNoLargeDogs;

    /**
     * Not good with male dogs
     * @var string
     */
    public $animalNoMaleDogs;

    /**
     * Not good with small dogs
     * @var string
     */
    public $animalNoSmallDogs;

    /**
     * Obedient
     * @var string
     */
    public $animalObedient;

    /**
     * Good for seniors / elderly
     * @var string
     */
    public $animalOKForSeniors;

    /**
     * Good with farm animals
     * @var string
     */
    public $animalOKWithFarmAnimals;

    /**
     * Older/ considerate kids only
     * @var string
     */
    public $animalOlderKidsOnly;

    /**
     * Needs ongoing medical care
     * @var string
     */
    public $animalOngoingMedical;

    /**
     * Playful
     * @var string
     */
    public $animalPlayful;

    /**
     * Likes toys
     * @var string
     */
    public $animalPlaysToys;

    /**
     * Predatory
     * @var string
     */
    public $animalPredatory;

    /**
     * Protective / territorial
     * @var string
     */
    public $animalProtective;

    /**
     * Sight impaired
     * @var string
     */
    public $animalSightImpaired;

    /**
     * Skittish
     * @var string
     */
    public $animalSkittish;

    /**
     * Special diet required
     * @var string
     */
    public $animalSpecialDiet;
