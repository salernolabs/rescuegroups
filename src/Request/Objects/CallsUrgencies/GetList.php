...
class GetList implements \RescueGroups\Request\RequestInterface, \RescueGroups\Request\ObjectActionInterface, \RescueGroups\Request\ProcessResponseInterface
{
     ...
     * @param \stdClass $data
     * @returns \RescueGroups\Response\Objects\CallsUrgency[]
     */
    public function processResponse(\RescueGroups\API $api, $data)
    {
        ...
        if (is_array($data))
        {
            ...
            {
                $output[] = new \RescueGroups\Response\Objects\CallsUrgency($object);
            }

            return $output;
        }

        return [new \RescueGroups\Response\Objects\CallsUrgency($data)];
    }
