...
class Add implements \RescueGroups\Request\RequestInterface, \RescueGroups\Request\ObjectActionInterface, \RescueGroups\Request\ParametersInterface
{
     ...
     * @return $this
     */
    public function setOutcomesReleaseIntakeID($value)
    {
        $this->outcomesReleaseIntakeID = $value;
    ...
    public function applyParameters(&$parameterArray)
    {
        ...
        if ($this->outcomesReleaseIntakeID !== null) $parameterArray['values'][] = ["outcomesReleaseIntakeID"=>$this->outcomesReleaseIntakeID];
