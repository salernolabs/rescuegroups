...
class GetList implements \RescueGroups\Request\RequestInterface, \RescueGroups\Request\ObjectActionInterface, \RescueGroups\Request\ProcessResponseInterface
{
     ...
     * @param \stdClass $data
     * @returns \RescueGroups\Response\Objects\AnimalAdoptionLead[]
     */
    public function processResponse(\RescueGroups\API $api, $data)
    {
        ...
        if (is_array($data))
        {
            ...
            {
                $output[] = new \RescueGroups\Response\Objects\AnimalAdoptionLead($object);
            }

            return $output;
        }

        return [new \RescueGroups\Response\Objects\AnimalAdoptionLead($data)];
    }
