...
class Add extends \RescueGroups\Request\Objects\Base implements \RescueGroups\Request\ParametersInterface
{
     ...
     * Addable  array
     *
     * @var \RescueGroups\Objects\Create\WebImage[]
     */
     ...
     *
     * @param \RescueGroups\Objects\Create\WebImage $addObject
     * @return $this
     */
    public function addWebImage(\RescueGroups\Objects\Create\WebImage $addObject)
    {
