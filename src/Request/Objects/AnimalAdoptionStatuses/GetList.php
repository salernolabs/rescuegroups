...
class GetList implements \RescueGroups\Request\RequestInterface, \RescueGroups\Request\ObjectActionInterface, \RescueGroups\Request\ParametersInterface, \RescueGroups\Request\ProcessResponseInterface
{
     ...
     * @param \stdClass $data
     * @returns \RescueGroups\Objects\AnimalAdoptionStatus[]
     */
    public function processResponse(\RescueGroups\API $api, $data)
    {
        ...
        if (is_array($data) || is_object($data))
        {
            ...
            {
                $output[] = new \RescueGroups\Objects\AnimalAdoptionStatus($object);
            }

            return $output;
        }

        return [new \RescueGroups\Objects\AnimalAdoptionStatus($data)];
    }
