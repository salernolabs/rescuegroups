...
class GetList implements \RescueGroups\Request\RequestInterface, \RescueGroups\Request\ObjectActionInterface, \RescueGroups\Request\ProcessResponseInterface
{
     ...
     * @param \stdClass $data
     * @returns \RescueGroups\Response\Objects\CallsStatus[]
     */
    public function processResponse(\RescueGroups\API $api, $data)
    {
        ...
        if (is_array($data) || is_object($data))
        {
            ...
            {
                $output[] = new \RescueGroups\Response\Objects\CallsStatus($object);
            }

            return $output;
        }

        return [new \RescueGroups\Response\Objects\CallsStatus($data)];
    }
