...
class Edit extends \RescueGroups\Request\Objects\Base implements \RescueGroups\Request\ParametersInterface
{
     ...
     * Editable  array
     *
     * @var \RescueGroups\Objects\OutcomesTransfer[]
     */
     ...
     *
     * @param \RescueGroups\Objects\OutcomesTransfer $editObject
     * @return $this
     */
    public function updateOutcomesTransfer(\RescueGroups\Objects\OutcomesTransfer $editObject)
    {
