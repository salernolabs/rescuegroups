...
class Contact implements \RescueGroups\Objects\APIEncodableInterface
{
    ...
    public function __construct($inputData = null)
    {
        ...
        if (!empty($inputData->contactSendInvite)) $this->endInvite = $inputData->contactSendInvite;
    ...
    public function getArray($includeId = true)
    {
        ...
        if ($this->endInvite !== null) $output['contactSendInvite'] = $this->endInvite;
