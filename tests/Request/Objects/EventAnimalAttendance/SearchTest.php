...
class SearchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $query
            ...
            ->addFilter('attendanceID', 'equals', 'ID')
            ->addField('attendanceStatus')
            ->addFilter('attendanceStatus', 'equals', 'Status')
            ->addField('attendanceAnimalID')
            ->addFilter('attendanceAnimalID', 'equals', 'Animal')
            ->addField('attendanceEventID')
            ->addFilter('attendanceEventID', 'equals', 'Event')
            ->addField('animalName')
