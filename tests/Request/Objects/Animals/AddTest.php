...
class AddTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $testObject->econdaryBreedID = 'testValue Secondary Breed';
        $testObject->ex = 'testValue Sex';
        $testObject->hared = 'testValue Shared';
        $testObject->hedding = 'testValue Shedding amount';
        $testObject->izeCurrent = 'testValue Current size';
        $testObject->izePotential = 'testValue Size potential';
        $testObject->izeUOM = 'testValue Size unit of measure';
        $testObject->pecialneeds = 'testValue Has special needs';
        $testObject->pecialneedsDescription = 'testValue Special needs description';
        $testObject->peciesID = 'testValue Species';
        $testObject->ponsorable = 'testValue Allow sponsorship';
        $testObject->ponsors = 'testValue Sponsors';
        $testObject->ponsorshipDetails = 'testValue Sponsorship details';
        $testObject->ponsorshipMinimum = 'testValue Sponsorship minimum';
        $testObject->tatusID = 'testValue Status';
        $testObject->ummary = 'testValue Summary';
        ...
        $testObject->animalOKWithFarm = 'testValue Good with farm animals';
        ...
        $testObject->ightImpaired = 'testValue Sight impaired';
        $testObject->kittish = 'testValue Skittish';
        $testObject->pecialDiet = 'testValue Special diet required';
        $testObject->wims = 'testValue Likes to swim';
