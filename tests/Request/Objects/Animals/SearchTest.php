...
class SearchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $query
            ...
            ->addFilter('animalSpecialneeds', 'equals', 'Has special needs')
            ->addField('animalSpecialneedsDescription')
            ->addFilter('animalSpecialneedsDescription', 'equals', 'Special needs description')
            ...
            ->addFilter('animalSecondaryBreed', 'equals', 'Secondary Breed')
            ->addField('animalSecondaryBreedID')
            ->addFilter('animalSecondaryBreedID', 'equals', 'Secondary Breed')
            ->addField('animalSex')
            ->addFilter('animalSex', 'equals', 'Sex')
            ->addField('animalShared')
            ->addFilter('animalShared', 'equals', 'Shared')
            ->addField('animalShedding')
            ->addFilter('animalShedding', 'equals', 'Shedding amount')
            ->addField('animalSizeCurrent')
            ->addFilter('animalSizeCurrent', 'equals', 'Current size')
            ->addField('animalSizePotential')
            ->addFilter('animalSizePotential', 'equals', 'Size potential')
            ->addField('animalSizeUOM')
            ->addFilter('animalSizeUOM', 'equals', 'Size unit of measure')
            ->addField('animalSpecies')
            ->addFilter('animalSpecies', 'equals', 'Species')
            ->addField('animalSpeciesID')
            ->addFilter('animalSpeciesID', 'equals', 'Species')
            ->addField('animalSponsorable')
            ->addFilter('animalSponsorable', 'equals', 'Allow sponsorship')
            ->addField('animalSponsors')
            ->addFilter('animalSponsors', 'equals', 'Sponsors')
            ->addField('animalSponsorshipDetails')
            ->addFilter('animalSponsorshipDetails', 'equals', 'Sponsorship details')
            ->addField('animalSponsorshipMinimum')
            ->addFilter('animalSponsorshipMinimum', 'equals', 'Sponsorship minimum')
            ->addField('animalStatus')
            ->addFilter('animalStatus', 'equals', 'Status')
            ->addField('animalStatusID')
            ->addFilter('animalStatusID', 'equals', 'Status')
            ->addField('animalSummary')
            ->addFilter('animalSummary', 'equals', 'Summary')
            ...
            ->addFilter('animalOKWithFarmAnimals', 'equals', 'Good with farm animals')
            ...
            ->addFilter('animalSightImpaired', 'equals', 'Sight impaired')
            ->addField('animalSkittish')
            ->addFilter('animalSkittish', 'equals', 'Skittish')
            ->addField('animalSpecialDiet')
            ->addFilter('animalSpecialDiet', 'equals', 'Special diet required')
            ->addField('animalSwims')
            ->addFilter('animalSwims', 'equals', 'Likes to swim')
