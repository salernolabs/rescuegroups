...
class SearchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $query
            ...
            ->addField('caretakers')
            ->addFilter('caretakers', 'equals', 'Caretakers')
            ->addField('locationId')
            ->addFilter('locationId', 'equals', 'Location')
            ->addField('name')
            ->addFilter('name', 'equals', 'Name')
            ->addField('totalAnimals')
            ->addFilter('totalAnimals', 'equals', 'Number of animals')
            ->addField('registeredDate')
            ->addFilter('registeredDate', 'equals', 'Registered')
            ->addField('specificLocation')
            ->addFilter('specificLocation', 'equals', 'Specific location')
