...
class EditTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $testObject->intakesImpoundID = 'testValue Impound';
        $testObject->intakesImpoundAnimalID = 'testValue Animal';
        ...
        $this->assertEquals('testValue Impound', $data['values'][0]['intakesImpoundID']);
        $this->assertEquals('testValue Animal', $data['values'][0]['intakesImpoundAnimalID']);
