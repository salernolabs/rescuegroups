...
class SearchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $query
            ...
            ->addField('formId')
            ->addFilter('formId', 'equals', 'Form')
            ->addField('animalId')
            ->addFilter('animalId', 'equals', 'Animal')
            ->addField('assignedTo')
            ->addFilter('assignedTo', 'equals', 'Assigned To')
            ->addField('assignedToId')
            ->addFilter('assignedToId', 'equals', 'Assigned To')
            ->addField('commentsCount')
            ->addFilter('commentsCount', 'equals', 'Comments Count')
            ->addField('commentsInline')
            ->addFilter('commentsInline', 'equals', 'Comments')
            ->addField('completed')
            ->addFilter('completed', 'equals', 'Completed Date')
            ->addField('updated')
            ->addFilter('updated', 'equals', 'Updated Date')
            ->addField('formName')
            ->addFilter('formName', 'equals', 'Form Name')
            ->addField('pending')
            ->addFilter('pending', 'equals', 'Pending')
            ->addField('status')
            ->addFilter('status', 'equals', 'Status')
            ->addField('statusId')
            ->addFilter('statusId', 'equals', 'Status')
            ->addField('answers')
            ->addFilter('answers', 'equals', 'Answers')
