...
class SearchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testQuery()
    {
        ...
        $query
            ...
            ->addField('itemId')
            ->addFilter('itemId', 'equals', 'Item')
            ->addField('loanDate')
            ->addFilter('loanDate', 'equals', 'Loan Date')
            ->addField('loanCondition')
            ->addFilter('loanCondition', 'equals', 'Loan Condition')
            ->addField('loanConditionId')
            ->addFilter('loanConditionId', 'equals', 'Loan Condition')
            ->addField('dueDate')
            ->addFilter('dueDate', 'equals', 'Due Date')
            ->addField('returnDate')
            ->addFilter('returnDate', 'equals', 'Return Date')
            ->addField('returnCondition')
            ->addFilter('returnCondition', 'equals', 'Return Condition')
            ->addField('returnConditionId')
            ->addFilter('returnConditionId', 'equals', 'Return Condition')
            ->addField('notes')
            ->addFilter('notes', 'equals', 'Notes')
            ->addField('lastDueReminderDate')
            ->addFilter('lastDueReminderDate', 'equals', 'Due Reminder Date')
